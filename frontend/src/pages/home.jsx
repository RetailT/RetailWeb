...
return (
  <motion.div
    className="min-h-screen bg-black text-white flex flex-col items-center p-8 overflow-x-hidden"
    initial="hidden"
    animate="visible"
    variants={fadeInUp}
  >
    {/* Logo Section */}
    <motion.div className="w-full flex flex-row justify-start items-center py-4 px-8 mt-5 ml-0 md:ml-64">
      <img className="w-28 h-15 sm:w-40 sm:h-18" src={logo1} alt="logo" />
      <img
        className="w-28 h-12 sm:w-40 sm:h-18 ml-3 md:ml-3"
        src={logo2}
        alt="logo"
      />
    </motion.div>
    ...
    {/* Content Section */}
    <motion.div
      className="flex flex-col md:flex-row w-full max-w-6xl px-8"
      variants={{
    ...
    >
      {/* Left Content */}
      <div className="w-full md:w-1/2 flex flex-col justify-start mt-10 mr-10 text-justify">
      ...
      {/* Image Gallery */}
      <motion.div
        className="w-full md:w-1/2 grid grid-cols-3 gap-4 mt-10"
        initial="hidden"
        animate="visible"
      >
        <motion.img
